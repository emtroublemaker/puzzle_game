...
var allimages = [
	{
		'name': 'pictures',
		'images':['puzzle.png', 'puzzle2.png'],
		'dir': ''
	},
];

function displayImage() {
	var num = Math.floor(Math.random() * allimages.length);
	document.getElementById("myPicture").src = allimages[num]
}
...
(function( window, undefined ) {
	var js = {
		...
		idealh: 1,
		canvasmode: 1,
		piececountx: 6, //number of pieces across - changed from original 6
		...
		general: {
			...
			initPuzzle: function(){
				...
				js.piececountx = 6; //changed from 6 to 3
				js.piececounty = 3;
			...
			releasePiece: function(){
				...
				if(js.clickedpiece !== -1){
					...
					if(js.pieces.length === 0){
						...
						localStorage.setItem("gameState","game1");
